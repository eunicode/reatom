**How to describe an asynchronous request chain and not break everything? Simple? I don't think so!**

I am the author of the Reatom state manager, and today I want to tell you about the main killer feature of redux-saga and rxjs and how you can now get it more simply, as well as about upcoming changes in the ECMAScript standard.
