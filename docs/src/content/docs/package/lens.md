---
title: lens
description: FRP operators and other utilities for the Reatom state manager
---
...
**THIS PACKAGE WILL BE DEPRECATED IN THE NEXT MAJOR RELEASE, please try to use[@reatom/effects](/package/effects) instead.**
